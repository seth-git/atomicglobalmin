...
public:
	...
	static bool createOpenBabelInputFile(MoleculeSet &moleculeSet, int populationMemberNumber, bool writeEnergyValueInHeader);
	static int readOutputFile(const char* outputFile, FLOAT &energy, MoleculeSet* pMoleculeSet);
	static int readGaussianOutputFile(const char* logFile, FLOAT &energy, MoleculeSet* pMoleculeSet);
	static int readOpenBabelOutputFile(const char* outputFile, FLOAT &energy, MoleculeSet* pMoleculeSet);
...
private:
	...
	static OpenBabel::OBConversion s_obConversion;
