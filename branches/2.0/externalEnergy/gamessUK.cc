...
const char GamessUK::s_sPathToExecutable[] = "/Full/path/to/Gamess/executable";
const char GamessUK::s_sInputFileExtension[] = "gamin";
const char GamessUK::s_sOutputFileExtension[] = "gamout";

const std::string GamessUK::s_sAtomsReplacement = "!atoms";

GamessUK::GamessUK(const ExternalEnergyXml* pExternalEnergyXml) : ExternalEnergy(pExternalEnergyXml) {
}

GamessUK::~GamessUK() {
}

bool GamessUK::createInputFile(const char* inputFileName, const Structure &structure) {
	std::string atoms;
	unsigned int i;
...
bool GamessUK::execute(Structure &structure) {
	using namespace std;
