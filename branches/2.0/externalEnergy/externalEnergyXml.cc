...
bool ExternalEnergyXml::readResultsDir(TiXmlElement *pElem, const Strings* messages) {
...
bool ExternalEnergyXml::save(TiXmlElement *pExternalElem, const Strings* messages)
{
	pExternalElem->SetAttribute(messages->m_sxMethod.c_str(), ExternalEnergy::getEnumString(m_method, messages));
